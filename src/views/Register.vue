<template>
  <div class="register">
    ...
    <div>
      ...
      <div class="login">
        <router-link class="login-text" to="/login">已有账号？<span>登录</span></router-link>
      </div>
          <div class="text-t"><span>第三方登录</span></div>
      <div class="logo-nav">
        <li><img src="../assets/logo/1.png" alt=""></li>
        <li><img src="../assets/logo/2.png" alt=""></li>
        <li><img src="../assets/logo/3.png" alt=""></li>
      </div>
    </div>
  </div>
</template>
